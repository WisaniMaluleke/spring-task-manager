...
<body class="flex flex-col min-h-screen md:h-screen md:overflow-hidden grid-bg">
    ...
    <nav class="z-50 border-b border-white/10 backdrop-blur-sm bg-black/30 shrink-0">
        <div class="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
            ...
            <div class="items-center hidden gap-8 text-sm md:flex text-white/75">
            ...
            <div class="flex items-center gap-3">
                <a href="/login" class="px-4 py-2 text-sm transition-colors text-white/75 hover:text-white">Sign in</a>
    ...
    <main class="flex flex-col flex-1 w-full min-h-0 gap-8 px-6 py-6 mx-auto overflow-y-auto md:flex-row max-w-7xl md:overflow-hidden">
        ...
        <section class="flex flex-col justify-center flex-1 min-w-0 py-4 md:py-0 fade-up">
            <div class="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/30 rounded-full px-3.5 py-1 text-xs font-medium text-indigo-300 w-fit mb-6">
            ...
            <p class="max-w-lg mb-8 text-base leading-relaxed text-white/75">
            ...
            <div class="flex items-center gap-4 mb-10">
                ...
                <a href="/swagger-ui/index.html" target="_blank" class="border border-white/20 hover:border-white/40 text-white/70 hover:text-white px-5 py-2.5 rounded-xl font-medium text-sm transition-all">
                    API Blueprint
                </a>
            </div>
            ...
            <div class="grid max-w-lg grid-cols-2 gap-3 fade-up-2">
                <div class="p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div class="text-xs text-white/75 mt-0.5">Database Query Latency</div>
                </div>
                <div class="p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    <div class="text-2xl font-bold text-indigo-400 font-display">PLG</div>
                    <div class="text-xs text-white/75 mt-0.5">Loki Log Aggregation</div>
                </div>
                <div class="p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    <div class="text-2xl font-bold text-indigo-400 font-display">100%</div>
                    <div class="text-xs text-white/75 mt-0.5">Containerized Topology</div>
                </div>
                <div class="p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    <div class="text-2xl font-bold text-indigo-400 font-display">JSP</div>
                    <div class="text-xs text-white/75 mt-0.5">Server-Side Views</div>
                </div>
            </div>
        </section>
        ...
        <section id="stack" class="flex-1 flex flex-col min-h-0 min-w-0 bg-white/[0.02] border border-white/10 rounded-2xl p-5 fade-up-3">
            <div class="mb-4 shrink-0">
                ...
                <p class="text-xs text-white/75">Every service module integrated into a unified network domain.</p>
            </div>
            ...
            <div class="flex-1 pr-1 space-y-3 md:overflow-y-auto custom-scrollbar">
                ...
                <div class="flex items-start gap-4 p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div>
                        ...
                        <p class="text-xs leading-relaxed text-white/40">Direct runtime visibility into the local PostgreSQL cluster exposed securely at port 8081.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4 p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div>
                        ...
                        <p class="text-xs leading-relaxed text-white/75">Automated live endpoint scanning documentation mapped directly to standard app controllers.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4 p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div>
                        ...
                        <p class="text-xs leading-relaxed text-white/75">Comprehensive testing layer parsing validation constraints, services logic, and repository endpoints.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4 p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div>
                        ...
                        <p class="text-xs leading-relaxed text-white/75">Automatic container logging runtime capturing container console stdout traces via standard Docker sockets.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4 p-4 border bg-white/5 border-white/10 rounded-xl card-hover">
                    ...
                    <div>
                        ...
                        <p class="text-xs leading-relaxed text-white/75">Server-side template parsing engine combining model context objects directly into compiled views.</p>
                    </div>
                </div>
    ...
    <footer class="border-t border-white/10 bg-black/20 shrink-0">
        <div class="flex items-center justify-between px-6 py-4 mx-auto text-xs max-w-7xl text-white/75">
